(function (global, factory) {
    ...
    (factory((global.ngidle = global.ngidle || {}, global.ngidle.core = global.ngidle.core || {}),global.Rx,global.ng.core));
}(this, (function (exports,rxjs_Rx,_angular_core) { 'use strict';
...
var EventTargetInterruptSource = (function (_super) {
    ...
    function EventTargetInterruptSource(target, events, throttleDelay) {
        ...
        events.split(' ').forEach(function (event) {
            var src = rxjs_Rx.Observable.fromEvent(target, event);
...
var Idle = (function () {
    ...
    Idle.prototype.interrupt = function (force, eventArgs) {
        ...
        if (force === true || this.autoResume === exports.AutoResume.idle ||
            (this.autoResume === exports.AutoResume.notIdle && !this.idling)) {
            this.watch(force);
        }
    };
...
var WindowInterruptSource = (function (_super) {
    __extends$2(WindowInterruptSource, _super);
...
var SimpleExpiry = (function (_super) {
    __extends$3(SimpleExpiry, _super);
...
var NgIdleModule = (function () {
    ...
    /** @nocollapse */
    NgIdleModule.ctorParameters = [];
    return NgIdleModule;
}());

var DEFAULT_INTERRUPTSOURCES = [new DocumentInterruptSource('mousemove keydown DOMMouseScroll mousewheel mousedown touchstart touchmove scroll')];
